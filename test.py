...
def snapshot(final=False):
    ...
    np.savetxt('{}/{}/imu_drot.txt'.format(trainroot, epoch), np.stack(imu_drots_list))
    np.savetxt('{}/{}/imu_dtrans.txt'.format(trainroot, epoch), np.stack(imu_dtrans_list))
    np.savetxt('{}/{}/imu_dvel.txt'.format(trainroot, epoch), np.stack(imu_dvels_list))
...
if __name__ == '__main__':
    ...
    loop_closure.read_from_file(args.data_root)
